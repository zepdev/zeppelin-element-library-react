...
// This file is from Material-UI core!!
...
function capitalize(string) {
  if (process.env.NODE_ENV !== "production" && typeof string !== "string") {
    throw new Error("ZepDev: capitalize(string) expects a string argument.");
  }
...
export default withStyles(styles, { name: "ZepSvgIcon" })(SvgIcon);
